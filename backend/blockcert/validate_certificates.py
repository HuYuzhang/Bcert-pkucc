...
from blockcert import cred_protocol
from blockcert import network_utils
from blockcert import utils
from blockcert.chainpoint import ChainPointV2
...
def validate_certificate(cert, issuer_identifier, testnet, blockchain_services):
    ...
    for i in range( len(data_before_issuance) )[1:] :
        #print("checking data before issuance!")
    ...
    for op_return in reversed(data_after_issuance):
        #print("checking data_after_issuance!")
